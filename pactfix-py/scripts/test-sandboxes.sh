...
# Test each project
PROJECTS=("python-project" "nodejs-project" "bash-project" "go-project" "dockerfile-project" "json-project" "toml-project" "ini-project" "helm-project" "gitlab-ci-project" "jenkins-project")
